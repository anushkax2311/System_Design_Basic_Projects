...
class SeasonalOffer extends Coupon {
    ...
    public SeasonalOffer(double pct, String cat) {
        this.percent = pct;
        this.category = cat;
        this.discountStrategy = DiscountStrategyManager.getInstance().getstrategy(StrategyType.PERCENT, percent, 0.0);
    }
...
class LoyaltyDiscount extends Coupon {
    ...
    @Override
    public double getDiscount(Cart cart) {
        return discountStrategy.calculate(cart.getCurrentTotal());
    }
...
class BulkPurchaseDiscount extends Coupon {
    ...
    public BulkPurchaseDiscount(double thr, double off) {
        this.threshold = thr;
        this.flatOff = off;
        this.discountStrategy = DiscountStrategyManager.getInstance().getstrategy(StrategyType.FLAT, flatOff, 0.0);
    }
...
class BankingCoupon extends Coupon {
    ...
    public BankingCoupon(String b, double ms, double pct, double offCap) {
        this.bank = b;
        this.minSpend = ms;
        this.percent = pct;
        this.offCap = offCap;
